...
function Label({ children }) {
  return (
    <p className="text-[10px] tracking-[0.28em] uppercase mb-4"
      style={{ ...sans, color: ACCENT }}>{children}</p>
  );
}
  ...
  return (
    <section className="relative flex items-center overflow-hidden" style={{ minHeight: "100svh" }}>
      <div className="absolute inset-0">
        <img src={IMG.boat} alt="Always Late Charters SeaVee, Marathon Key FL"
          className="w-full h-full object-cover"
          style={{ objectPosition: "center 35%", animation: "slowZoom 16s ease-out forwards" }} />
        <div className="absolute inset-0"
          style={{ background: "linear-gradient(to bottom, rgba(10,14,12,0.55) 0%, rgba(10,14,12,0.25) 45%, rgba(10,14,12,0.70) 100%)" }} />
        <div className="absolute inset-0"
          style={{ background: "linear-gradient(to right, rgba(10,14,12,0.50) 0%, transparent 65%)" }} />
      </div>

      <div className="relative z-10 w-full max-w-screen-xl mx-auto px-6 lg:px-14 pt-32 pb-24">
        <Label>Marathon Key, Florida · Mile Marker 53</Label>
        <h1 className="text-white leading-[0.88] mb-8"
          style={{ ...serif, fontSize: "clamp(3.2rem, 8vw, 8rem)", fontWeight: 300, textShadow: "0 2px 24px rgba(0,0,0,0.35)" }}>
          Your Best Day
          <br /><em style={{ fontStyle: "italic", fontWeight: 400 }}>on the Water.</em>
          <br /><span className="text-white/60" style={{ fontSize: "0.72em", fontWeight: 300 }}>Guaranteed.</span>
        </h1>
        <div className="w-16 h-px mb-6" style={{ backgroundColor: "rgba(255,255,255,0.4)" }} />
        <p className="text-white/55 text-[11px] tracking-[0.32em] uppercase mb-12" style={sans}>
          Private Charters · Deep Sea · Reef · Family Trips
        </p>
        <div className="flex flex-col sm:flex-row items-start gap-5">
          <a href={PHONE_TEL}
            className="flex items-center gap-3 text-white text-sm tracking-[0.2em] uppercase px-8 py-4 transition-all duration-300"
          ...
          <a href="#catch"
            ...
            <span className="text-[12px] tracking-[0.3em] uppercase" style={sans}>See the Catch</span>
      ...
      <div className="absolute bottom-0 left-0 right-0"
        style={{ background: "rgba(10,14,12,0.80)", backdropFilter: "blur(10px)" }}>
        <div className="max-w-screen-xl mx-auto px-6 lg:px-14 py-5 grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <div key={s.label} className="flex flex-col gap-1">
              ...
              <span className="text-[9px] tracking-[0.3em] uppercase" style={{ ...sans, color: "rgba(255,255,255,0.38)" }}>{s.label}</span>
            </div>
          ))}
        </div>
      </div>
...
function About() {
  return (
    <section style={{ backgroundColor: BG_ALT, overflow: "hidden" }}>
      <div className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <div className="relative">
            <div className="overflow-hidden" style={{ height: "clamp(360px, 55vw, 740px)" }}>
              <img src={IMG.boat} alt="SeaVee center console Always Late Charters"
                className="w-full h-full object-cover transition-transform duration-700 hover:scale-[1.03]"
                style={{ objectPosition: "center 40%" }} />
            </div>
            <div className="absolute bottom-8 right-0 lg:translate-x-8 p-7 text-center"
              style={{ backgroundColor: TEXT, minWidth: "160px" }}>
              <div className="font-light leading-none mb-1" style={{ ...serif, fontSize: "3.2rem", color: ACCENT }}>FL</div>
          ...
          <div className="flex flex-col justify-center px-8 py-20 lg:py-28 lg:pl-16 lg:pr-10">
            <Label>The Always Late Experience</Label>
            ...
            <p className="text-[15px] leading-[1.9] mb-7" style={{ ...sans, color: MUTED }}>
            ...
            <p className="text-[15px] leading-[1.9] mb-12" style={{ ...sans, color: MUTED }}>
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                <div key={s.label}>
                  <div className="font-light mb-1" style={{ ...serif, fontSize: "2rem", color: TEXT }}>{s.value}</div>
...
function Vessel() {
  return (
    <section id="vessel" className="py-24 lg:py-32 overflow-hidden" style={{ backgroundColor: BG }}>
      <div className="max-w-screen-xl mx-auto px-6 lg:px-14">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-14">
          <div>
            <Label>The Vessel</Label>
            <h2 className="leading-[0.88]"
              style={{ ...serif, fontSize: "clamp(2.6rem, 5vw, 5rem)", fontWeight: 300, color: TEXT }}>
              Purpose-Built for
        ...
        <div className="relative overflow-hidden mb-0">
          <div className="overflow-hidden w-full" style={{ height: "clamp(240px, 48vw, 580px)" }}>
            <img src={IMG.boat} alt="Always Late Charters SeaVee center console"
              className="w-full h-full object-cover transition-transform duration-700 hover:scale-[1.02]"
              style={{ objectPosition: "center 38%" }} />
            <div className="absolute inset-0"
              style={{ background: "linear-gradient(to top, rgba(10,14,12,0.85) 0%, transparent 55%)" }} />
          </div>
          <div className="absolute bottom-8 left-7 lg:left-10">
            <p className="text-[9px] tracking-[0.4em] uppercase mb-2" style={{ ...sans, color: ACCENT }}>Our Boat</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-8 border-t border-b"
          ...
          {[
            ...
            <div key={s.label} className="flex flex-col gap-1.5">
              <span className="text-[9px] tracking-[0.36em] uppercase" style={{ ...sans, color: MUTED }}>{s.label}</span>
              <span className="font-light tracking-wide" style={{ ...serif, fontSize: "1.2rem", color: TEXT }}>{s.value}</span>
            </div>
          ))}
        </div>
        ...
        <div className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-10">
          {[
            { label: "Tackle & Bait",       desc: "Full rod and reel setups for all techniques — live bait, trolling, bottom fishing. We rig it, you reel it." },
            { label: "Fish Cleaning",        desc: "Every keeper gets cleaned and bagged on return to the dock. Take your catch straight to dinner." },
            { label: "Captain's Knowledge", desc: "Years running these reefs, wrecks, and offshore edges. We don't guess — we put you on fish." },
          ].map((item) => (
            <div key={item.label} className="pl-7 border-l" style={{ borderColor: `${ACCENT}40` }}>
              <p className="text-[9px] tracking-[0.36em] uppercase mb-3" style={{ ...sans, color: ACCENT }}>{item.label}</p>
              <p className="text-[14px] leading-[1.85]" style={{ ...sans, color: MUTED }}>{item.desc}</p>
            </div>
          ))}
        </div>
      </div>
...
function CatchGallery() {
  ...
  return (
    <section id="catch" className="py-24 lg:py-32 overflow-hidden" style={{ backgroundColor: BG_PAN }}>
      <div className="max-w-screen-xl mx-auto px-6 lg:px-14">
        <div className="text-center mb-16">
          <Label>Real Catches. Real Clients.</Label>
          <h2 className="leading-[0.9]"
            style={{ ...serif, fontSize: "clamp(2.6rem, 5vw, 4.8rem)", fontWeight: 300, color: TEXT }}>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4">
          ...
          {[photos[6], photos[7]].map((p) => (
            <div key={p.caption} className="col-span-2 relative overflow-hidden group"
              style={{ height: "clamp(180px, 24vw, 320px)" }}>
              <img src={p.src} alt={p.caption}
                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.04]" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" />
              <div className="absolute bottom-5 left-5">
                <p className="text-white font-light text-lg mb-0.5" style={serif}>{p.caption}</p>
                <p className="text-white/60 text-[10px] tracking-[0.25em] uppercase" style={sans}>{p.sub}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-12 text-center">
          <a href={PHONE_TEL}
            ...
            style={{ ...sans, backgroundColor: TEXT }}
...
function Trips() {
  const trips = [
    { label: "Offshore Deep Sea",    tagline: "Mahi · Tuna · Wahoo",   href: "/offshore",
      ...
      img: IMG.dolphin, duration: "Full or ¾ Day" },
    { label: "Reef & Bottom Fishing", tagline: "Grouper · Snapper · Hogfish", href: "/reef",
      ...
      img: IMG.grouperFamily, duration: "Half or Full Day" },
    { label: "Shark Fishing",         tagline: "Bull · Blacktip · Spinner", href: "/shark",
      desc: "High-adrenaline shark charters targeting Bull, Blacktip, and Spinner Sharks. 100% catch and release. Acrobatic fights, dramatic boatside action — unforgettable for the whole group.",
      img: IMG.tuna, duration: "Full Day" },
  ];

  return (
    <section className="py-24 lg:py-32 overflow-hidden" style={{ backgroundColor: BG_ALT }}>
      <div className="max-w-screen-xl mx-auto px-6 lg:px-14">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {trips.map((t) => (
            <a href={t.href} key={t.label}
              ...
              onMouseLeave={(e) => (e.currentTarget.style.borderColor = `${TEXT}12`)}>
              <div className="relative overflow-hidden" style={{ height: "clamp(220px, 28vw, 360px)" }}>
                <img src={t.img} alt={t.label}
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.06]" />
                <div className="absolute inset-0"
                  style={{ background: "linear-gradient(to top, rgba(10,14,12,0.80) 0%, rgba(10,14,12,0.15) 60%, transparent 100%)" }} />
                <div className="absolute bottom-5 left-5 right-5">
                  <p className="text-[9px] tracking-[0.4em] uppercase mb-1" style={{ ...sans, color: ACCENT }}>{t.duration}</p>
                  <h3 className="text-white text-2xl font-light" style={serif}>{t.label}</h3>
                  <p className="text-white/50 text-[10px] tracking-[0.2em] uppercase mt-1" style={sans}>{t.tagline}</p>
                </div>
              </div>
              <div className="flex flex-col flex-1 p-6" style={{ backgroundColor: BG }}>
                <p className="text-[14px] leading-[1.85] flex-1 mb-5" style={{ ...sans, color: MUTED }}>{t.desc}</p>
                <div className="flex items-center gap-3 text-[10px] tracking-[0.28em] uppercase transition-colors duration-300"
...
function Reviews() {
  const reviews = [
    { quote: "Captain put us on Mahi non-stop for 6 hours straight. Kids and adults alike were worn out from reeling. Best fishing trip our family has ever taken — and we've done a lot of them.",
      name: "The Martinez Family", from: "Orlando, FL", trip: "Offshore Mahi Charter" },
    { quote: "We've been booking with Always Late for three years running. The grouper fishing is world-class and the captain knows every wreck on the chart. Always comes home with a full cooler.",
      name: "Mike T.", from: "Atlanta, GA", trip: "Reef & Bottom Fishing" },
    { quote: "Took my 10-year-old on his first fishing trip. The captain was incredibly patient, kept the action going the whole time, and my son caught the biggest fish of the day. He hasn't stopped talking about it.",
      name: "Chris R.", from: "Nashville, TN", trip: "Family Half-Day Trip" },
  ];

  return (
    <section id="reviews" className="py-24 lg:py-36" style={{ backgroundColor: BG }}>
      <div className="max-w-screen-xl mx-auto px-6 lg:px-14">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-16 lg:mb-20">
          <div>
            <Label>What Clients Say</Label>
            <h2 className="leading-[0.9]"
              style={{ ...serif, fontSize: "clamp(2.4rem, 4.5vw, 4.5rem)", fontWeight: 300, color: TEXT }}>
              5 Stars.
              <br /><em style={{ fontStyle: "italic", fontWeight: 400 }}>Every Time.</em>
            </h2>
          </div>
          <div className="flex items-center gap-2">
            {[0,1,2,3,4].map(i => <StarIcon key={i} className="w-5 h-5" style={{ color: ACCENT }} />)}
            <span className="ml-3 text-sm" style={{ ...sans, color: MUTED }}>Google Reviews</span>
          </div>
        </div>
          ...
          {reviews.map((r, i) => (
            <div key={r.name} className="flex flex-col" style={{ paddingTop: i === 1 ? "2rem" : "0" }}>
              <span className="font-light leading-none mb-5 select-none"
                style={{ ...serif, fontSize: "4.5rem", color: `${ACCENT}30`, lineHeight: 1 }}>&ldquo;</span>
              <p className="font-light leading-[1.75] flex-1 mb-8"
                style={{ ...serif, fontSize: "clamp(1.05rem, 1.8vw, 1.25rem)", color: TEXT }}>{r.quote}</p>
              <div className="flex items-center gap-4">
                <div className="w-6 h-px flex-shrink-0" style={{ backgroundColor: ACCENT }} />
                <div>
                  <div className="text-[13px] tracking-[0.08em]" style={{ ...sans, color: TEXT }}>{r.name}</div>
                  <div className="text-[10px] tracking-[0.24em] uppercase mt-0.5" style={{ ...sans, color: MUTED }}>
                    {r.from} · {r.trip}
                  </div>
                </div>
              </div>
...
function Contact() {
  ...
  const inputBase = { ...sans, color: TEXT, background: "transparent",
    borderBottom: `1px solid ${TEXT}20`, outline: "none",
    fontSize: "15px", fontWeight: 300, paddingBottom: "10px", width: "100%", transition: "border-color 0.3s" };
  const focusBorder = (e) => (e.currentTarget.style.borderBottomColor = ACCENT);
  const blurBorder  = (e) => (e.currentTarget.style.borderBottomColor = `${TEXT}20`);

  return (
    <section id="contact" className="py-24 lg:py-32" style={{ backgroundColor: BG_PAN }}>
      <div className="max-w-screen-xl mx-auto px-6 lg:px-14">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-28">
          <div>
            <Label>Book a Charter</Label>
            <h2 className="leading-[0.88] mb-9"
              style={{ ...serif, fontSize: "clamp(2.4rem, 4.5vw, 4.5rem)", fontWeight: 300, color: TEXT }}>
              Ready to Go?
              <br /><em style={{ fontStyle: "italic", fontWeight: 400 }}>Let&apos;s Talk.</em>
            </h2>
            <p className="text-[15px] leading-[1.88] mb-14" style={{ ...sans, color: MUTED }}>
            ...
            <div className="flex flex-col gap-6 border-l pl-7" style={{ borderColor: `${ACCENT}35` }}>
              {[
                ...
                <div key={c.label}>
                  <p className="text-[9px] tracking-[0.4em] uppercase mb-1" style={{ ...sans, color: MUTED }}>{c.label}</p>
                  {c.href ? (
                    <a href={c.href} className="text-[15px] font-light transition-colors duration-300"
                      style={{ ...sans, color: TEXT }}
                      onMouseEnter={(e) => (e.currentTarget.style.color = ACCENT)}
                      onMouseLeave={(e) => (e.currentTarget.style.color = TEXT)}>{c.value}</a>
                  ) : (
                    <span className="text-[15px] font-light" style={{ ...sans, color: MUTED }}>{c.value}</span>
                  )}
                </div>
              ))}
            </div>
          ...
          <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-9">
            ...
            <div className="grid grid-cols-2 gap-8">
              <div className="flex flex-col gap-2">
                ...
                <input id="date" type="date" style={inputBase} onFocus={focusBorder} onBlur={blurBorder} />
              </div>
              <div className="flex flex-col gap-2">
                <label htmlFor="triptype" className="text-[9px] tracking-[0.42em] uppercase"
                  style={{ ...sans, color: MUTED }}>Trip Type</label>
                <select id="triptype" style={{ ...inputBase, appearance: "none", cursor: "pointer" }}
                  onFocus={focusBorder} onBlur={blurBorder}>
                  <option value="">Select…</option>
                  <option value="offshore">Offshore Deep Sea</option>
                  <option value="reef">Reef & Bottom Fishing</option>
                  <option value="shark">Shark Fishing</option>
                  <option value="family">Family / Kids Trip</option>
                </select>
              </div>
            </div>
            <div className="flex flex-col gap-2">
              <label htmlFor="guests" className="text-[9px] tracking-[0.42em] uppercase"
                style={{ ...sans, color: MUTED }}>Party Size</label>
              <select id="guests" style={{ ...inputBase, appearance: "none", cursor: "pointer" }}
                onFocus={focusBorder} onBlur={blurBorder}>
                <option value="">How many guests?</option>
                {["1–2","3–4","5–6","7+"].map(o => <option key={o} value={o}>{o} guests</option>)}
              </select>
            </div>
            <div className="flex flex-col gap-2">
              <label htmlFor="msg" className="text-[9px] tracking-[0.42em] uppercase"
                style={{ ...sans, color: MUTED }}>Message (Optional)</label>
              <textarea id="msg" rows={3} placeholder="Target species, occasion, or anything else we should know."
                style={{ ...inputBase, resize: "none" }} onFocus={focusBorder} onBlur={blurBorder} />
            </div>
            <div className="flex items-center justify-between pt-2">
              <p className="text-[9px] tracking-[0.2em] uppercase" style={{ ...sans, color: MUTED }}>We reply same day</p>
              <button type="submit"
                className="flex items-center gap-3 text-white text-[11px] tracking-[0.3em] uppercase px-9 py-4 transition-all duration-300"
                style={{ ...sans, backgroundColor: ACCENT }}
                onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "#7a6347")}
                onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = ACCENT)}>
