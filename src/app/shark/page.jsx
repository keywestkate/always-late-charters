...
const faqItems = [
  { name: "What sharks can I catch off Marathon, Florida?",
    answer: "The waters off Marathon hold Bull Sharks, Blacktip Sharks, Spinner Sharks, Lemon Sharks, Nurse Sharks, and occasional Tiger Sharks and Hammerheads. Blacktips and Spinners are the most commonly targeted — aggressive, acrobatic fighters that jump repeatedly during the fight. Bull Sharks are larger and more powerful. Captain Lucas targets the species most active based on season and conditions." },
  { name: "What size sharks can I expect to catch?",
    answer: "Blacktip and Spinner Sharks typically run 50–150 lbs in the waters off Marathon, with occasional fish over 200 lbs. Bull Sharks average 200–300 lbs, with larger individuals well documented in this area. Lemon Sharks reach 250+ lbs. The fight on a 150-lb Blacktip is remarkable — they are one of the fastest, most acrobatic sharks in Florida waters. All sharks are released alive." },
  { name: "Is shark fishing dangerous?",
    answer: "On a professionally run charter, shark fishing is safe. Captain Lucas handles all leader work and boat-side procedures — clients fight the fish from the rod, and the captain manages the shark for tagging, photography, and release. We do not bring sharks aboard. USCG licensed, fully insured." },
  { name: "Do we keep the sharks?",
    answer: "No. Always Late Charters practices mandatory catch-and-release on all shark trips. This is non-negotiable. The shark fishery in the Florida Keys is under significant pressure, and Captain Lucas is committed to releasing every shark in good condition. You leave with the photos and the memory." },
];
      ...
      <div style={{ overflowX: "hidden" }}>
        ...
        <section className="relative flex items-center justify-center overflow-hidden" style={{ minHeight: "60vh" }}>
          <div className="absolute inset-0"
            style={{ background: "linear-gradient(135deg, #1a2a3a 0%, #0a3d62 60%, #0e6b8a 100%)" }} />
          <div className="absolute inset-0 opacity-15"
            style={{ backgroundImage: "radial-gradient(circle at 70% 40%, #8B7355 0%, transparent 55%)" }} />
          <div className="relative z-10 text-center px-6 lg:px-14 pt-28 pb-20 max-w-4xl mx-auto">
            <Label>High-Adrenaline · Marathon, FL</Label>
            ...
            <p className="text-[15px] leading-relaxed max-w-2xl mx-auto mb-10"
              ...
              Captain Lucas runs targeted shark trips for those who want the most powerful, adrenaline-driven
              experience the Florida Keys can offer. All sharks released.
            </p>
            <a href={PHONE_TEL}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <p className="text-[15px] leading-[1.92] mb-6" style={{ ...sans, color: MUTED }}>
                  Shark fishing in Marathon requires reading current lines, working structure, and deploying the right
                  bait presentation at the right depth. Captain Lucas targets the zones where Blacktips, Spinners,
                  and Bulls are actively feeding based on time of year and water conditions.
                </p>
                <p className="text-[15px] leading-[1.92] mb-6" style={{ ...sans, color: MUTED }}>
                  Blacktip and Spinner Sharks are among the most acrobatic fish in Florida — they leap and spin when
                  hooked, providing a visual spectacle alongside the pure power of a 100-lb fish on heavy tackle.
                </p>
                <p className="text-[15px] leading-[1.92]" style={{ ...sans, color: MUTED }}>
                  All sharks are caught, photographed, measured, and released alive.
                </p>
              </div>
              <div className="flex flex-col gap-5">
                {[
                  ...
                  { label: "Tackle & Setup",  desc: "Heavy spinning and conventional tackle rated for 80–150 lb fish. Live and cut bait deployed with chum slicks. Captain Lucas handles all leader work." },
                  ...
                  { label: "Safety Protocol", desc: "USCG licensed. Fully insured. Captain handles all close-contact work. Clear safety briefing before every trip." },
                ].map(t => (
          ...
          <div className="max-w-screen-lg mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {[
                ...
                { name: "Spinner Shark",   avg: "50–100 lbs",  note: "Spectacular aerial display. Warm months near structure." },
                { name: "Bull Shark",      avg: "200–350 lbs", note: "Most powerful inshore shark. Raw strength fight. Year-round." },
                { name: "Lemon Shark",     avg: "100–250 lbs", note: "Impressive size. Year-round in channels." },
                { name: "Nurse Shark",     avg: "100–200 lbs", note: "Surprising fight. Year-round shallows." },
                { name: "Tiger / Hammer",  avg: "200+ lbs",    note: "Occasional offshore encounters. Not reliably targeted." },
              ].map(s => (
                <div key={s.name} className="p-5 border" style={{ borderColor: `${TEXT}10`, backgroundColor: BG_ALT }}>
                  <div className="font-light mb-1" style={{ ...sans, fontSize: "14px", color: TEXT }}>{s.name}</div>
                  <div className="text-[10px] tracking-[0.2em] uppercase mb-2" style={{ ...sans, color: ACCENT }}>{s.avg}</div>
                  <div className="text-[12px]" style={{ ...sans, color: MUTED }}>{s.note}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-20 lg:py-24 px-6 lg:px-14 text-center" style={{ backgroundColor: BG_ALT }}>
          <div className="max-w-xl mx-auto">
            <Label>Book a Shark Charter</Label>
            ...
            <p className="text-[15px] leading-relaxed mb-10" style={{ ...sans, color: MUTED }}>
              Full-day shark charters. Call Captain Lucas to check availability and discuss the right trip.
            </p>
            <a href={PHONE_TEL}
